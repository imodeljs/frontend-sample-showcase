...
export class HeatmapDecoratorUIComponent extends React.Component<HeatmapDecoratorUIProps, HeatmapDecoratorUIState> {
  ...
  public render() {
    return (
      <>
        <ReloadableViewport iModelName={this.props.iModelName} onIModelReady={this.onIModelReady} getCustomViewState={HeatmapDecoratorUIComponent.getTopView} />
        {this.getControlPane()}
      </>
    );
  }
