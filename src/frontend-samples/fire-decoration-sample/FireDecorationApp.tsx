...
export default class FireDecorationApp implements SampleApp {
  ...
  public static highlightEmitter(emitter?: FireEmitter) {
    ...
    if (FireDecorationApp._highlighter) {
      IModelApp.viewManager.dropDecorator(FireDecorationApp._highlighter);
      FireDecorationApp._highlighter = undefined;
    }
    if (emitter) {
      FireDecorationApp._highlighter = new EmitterHighlighter(emitter);
      IModelApp.viewManager.addDecorator(FireDecorationApp._highlighter);
    }
  }
