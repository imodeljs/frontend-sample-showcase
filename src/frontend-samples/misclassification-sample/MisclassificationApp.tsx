...
const MisclassificationApp: FunctionComponent = () => {
  const sampleIModelInfo = useSampleWidget("Click a table row to zoom in on a misclassification.", [SampleIModels.RetailBuilding]);
...
export default MisclassificationApp;
