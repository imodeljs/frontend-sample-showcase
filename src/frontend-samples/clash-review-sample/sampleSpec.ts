...
export function getClashReviewSpec(): SampleSpec {
  return ({
    ...
    files: () => [
      { name: "frontend-samples/clash-review-sample/ClashReviewApi.ts", import: import("!!raw-loader!./ClashReviewApi") },
      { name: "frontend-samples/clash-review-sample/ClashReviewApp.tsx", import: import("!!raw-loader!./ClashReviewApp.tsx"), entry: true },
