...
export class EmphasizeAction extends EmphasizeActionBase {
  ...
  public constructor(elementIds: Id64String[], wantEmphasis: boolean) {
    super();
  ...
  public execute(emph: EmphasizeElements, vp: ScreenViewport): boolean {
    ...
    emph.emphasizeElements(this._elementIds, vp, undefined, false);
    return true;
  }
}
...
export class OverrideAction extends EmphasizeActionBase {
  ...
  public constructor(elementIds: Id64String[], colorValue: ColorDef, replace: boolean) {
    super();
    this._elementIds = elementIds;
  ...
  public execute(emph: EmphasizeElements, vp: ScreenViewport): boolean {
    emph.overrideElements(this._elementIds, vp, this._colorValue, FeatureOverrideType.ColorOnly, this._replace);
    return true;
  }
}
